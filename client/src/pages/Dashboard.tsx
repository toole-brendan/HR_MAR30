        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" className="text-xs" onClick={() => toast({ title: "Report Generated", description: "Accountability report has been generated and sent to your email." })}>
                <FileDown className="h-4 w-4 mr-1" /> Export Report
              </Button>
            </CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-md">
                <p className="text-sm text-gray-500 dark:text-gray-400">Sensitive Items</p>
              ...
              <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-md">
                <p className="text-sm text-gray-500 dark:text-gray-400">Due for Inventory</p>
            ...
            <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline" className="bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400">Verified Today</Badge>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline" className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400">Verify Required</Badge>
                </div>
              </div>
            </div>
          </CardContent>
                      ...
                      {transfer.status === "pending" ? (
                        <>
                          <Button 
                            variant="outline" 
                            size="sm"
                            className="bg-green-50 text-green-700 hover:bg-green-100 hover:text-green-800 dark:bg-green-900/20 dark:text-green-400 dark:hover:bg-green-900/30"
                          ...
                          <Button 
                            variant="outline" 
                            size="sm"
                            className="bg-red-50 text-red-700 hover:bg-red-100 hover:text-red-800 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30"
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">03/07/2025 09:45 AM</p>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 text-sm">
                  ...
                  <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded">
                    ...
                    <p className="text-xl text-green-600 dark:text-green-400">+5</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded">
                    <p className="font-medium">Issues</p>
                    <p className="text-xl text-yellow-600 dark:text-yellow-400">2</p>
                  </div>
                </div>
              </div>
